...
full_join(counties_elexresults, counties_rural_urban_suburban) -> joined_results
...
```{r}
inner_join(counties_demographics, counties_elexresults) -> joined_2
...
joined_2 %>% 
  filter(county_name == "New Hanover County") %>% 
  group_by(pct_ed_college_white) %>% 
